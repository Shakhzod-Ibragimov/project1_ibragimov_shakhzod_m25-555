...
' назовите слово "шаг" три раза подряд (введите "шаг шаг шаг")', 'шаг шаг шаг'
),
    },
    'library': {
...
' (подсказка: это число пятикратного шага, 2*5= ? )', '10'
    ...
    'secret_room': {
        'description': 'Тайная комната за оружейной. Здесь тихо и холодно.',
        'exits': {'west': 'armory'},
        'items': ['treasure_key'],
        'puzzle': None
    },
    ...
    'garden': {
        'description': 'Заросший внутренний двор с древним фонтаном.',
